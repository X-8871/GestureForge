...
实施流程遵循 [[工程协作规范]]，关口判定见 [[04-提交材料/验收执行手册]]。本计划 S0—S8 是工程阶段，P0—P4 为历史时间安排，不一一等同。数值建议在相应任务 G0 冻结，不把建议冒充官方要求。开工任务 S0-T01/T02 不覆盖整个 S0；MAC 单元正确不代表 S2 整网通过。本文保留阶段指标唯一正文，不在模板复制第二套。
